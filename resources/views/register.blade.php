...
<div class="container">
    <div class="col-12">
        ...
        <form action="login" method="POST" class="form-signin">
            ...
            <div class="pt-8">
                ...
                {{--                <input type="text" id="rcpNumber" class="form-control " placeholder="Numer Karty Rcp" required autofocus>--}}
                {{--                <div class="pt-8">--}}
    ...
    <div class="pt-8">
        ...
        {{--            <button type="button" class="btn btn-lg btn-outline-primary btn-block">Kontynuuj bez logowania</button>--}}
        </form>
    </div>
