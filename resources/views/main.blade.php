...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
    ...
    <a class="btn btn-outline-danger" href="#">Wyloguj</a>
</div>
        ...
        <div class="card-deck mb-3 text-center">
            <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-lg btn-block btn-outline-primary">Dodaj teczkę</button>
                </div>
            </div>
            <div class="card mb-4 box-shadow">
                <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-lg btn-block btn-outline-primary">Pobierz dokument</button>
                </div>
            </div>
            <div class="card mb-4 box-shadow">
                <div class="card-header">
        ...
        <div class="card-deck mb-3 text-center">
            <div class="card mb-4 box-shadow">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-lg btn-block btn-outline-primary">Sprawdź lokalizację</button>
                </div>
            </div>
            <div class="card mb-4 box-shadow">
                <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-lg btn-block btn-outline-primary">Sprawdź historię</button>
                </div>
            </div>
{{--            <div class="card mb-4 box-shadow">--}}
{{--                <div class="card-header">--}}
...
</body><app-content ng-version="14.2.0"></app-content></html>
