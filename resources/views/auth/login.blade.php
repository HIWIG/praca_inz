...
<div class="container">
    <div class="col-12">
        <form action="{{route('login-user')}}" method="post" class="form-signin">
        <h1 class="h3 mb-3 font-weight-normal pt-8">Logowanie</h1>
            ...
            <div class="pt-3">
                ...
                <input type="number" id="rcpOsoby" name="rcpNumber" value="" placeholder="Numer Karty RFID" readonly class="form-control">
            ...
            <div class="pt-3">
                <button type="submit" class="btn btn-lg btn-primary btn-block pt-8">Zaloguj</button>
            </div>
        </form>
    </div>
    </div>
