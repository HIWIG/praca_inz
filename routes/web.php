...
Route::get('/',[MyAuthController::class,'login'])->middleware('alreadyLoggedIn');
...
Route::post('/return-file',[FileController::class,'returnFilePost'])->name('take-file')->middleware('isLoggedIn');
